export default function DiagnosticSnapshot() {
  return (
    <div className="signal-surface live-card rounded-xl border border-red-600/40 bg-axi-gray p-8 shadow-[0_0_25px_rgba(225,6,0,0.12)] transition-all duration-300 hover:shadow-[0_0_60px_rgba(225,6,0,0.2)]">
      ...
      {[
        ...
        <div
          key={label}
          className="signal-line flex justify-between border-b border-white/10 py-4"
        >
