    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-12 md:py-14">
        <div className="rounded-2xl border border-red-600/40 bg-axi-gray p-8 text-center shadow-[0_0_40px_rgba(225,6,0,0.08)] transition-all duration-300 hover:shadow-[0_0_70px_rgba(225,6,0,0.15)] md:p-10">
          ...
          <Link
            to="/contact"
            className="mt-7 inline-block rounded-xl bg-axi-red px-8 py-4 font-black shadow-[0_10px_30px_rgba(225,6,0,0.25)] transition-all duration-300 ease-out hover:delay-75 hover:scale-[1.04] hover:shadow-[0_25px_70px_rgba(225,6,0,0.35)] active:scale-[0.98]"
          >
            Get My Breakdown
          </Link>
        </div>
